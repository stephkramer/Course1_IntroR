...
---
# Basics
This first outline of this course has been developed in 2012 by Alex Courtiol and has ever since 'evolved' in courses I gave. The short intro contains the most important commands and functions to handle and manipulate data needed for following the course 'biodiversity dynamics'.

The first outline of this course has been developed in 2012 by Alex Courtiol and has ever since 'evolved' in courses I gave and plished by Moritz. This short intro contains the most important commands and functions to handle and manipulate data needed for following the course 'biodiversity dynamics'. Open your RStudio and paste the lines in the grey boxes into your R file and follow the course...
